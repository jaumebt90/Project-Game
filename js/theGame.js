    ...
    checkIfCollision() {
        if (this.zombie.length) {
          this.zombie.forEach(elem => {
            ...
            if (
              this.newKid.kidPosition.x < elem.zombiePosition.x + elem.zombieSize.w &&
              this.newKid.kidPosition.x + this.newKid.kidSize.w > elem.zombiePosition.x &&
              this.newKid.kidPosition.y < elem.zombiePosition.y + elem.zombieSize.h &&
              this.newKid.kidSize.h + this.newKid.kidPosition.y > elem.zombiePosition.y
            ) {
